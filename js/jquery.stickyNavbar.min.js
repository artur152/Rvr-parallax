...
(function ($, window, document) {
    ...
    $.fn.stickyNavbar = function (prop) {
        ...
        var options = $.extend({
                ...
                animDuration: 2000, // Duration of jQuery animation as well as jQuery scrolling duration
        ...
        return this.each(function () {
            ...
            var $self = $(this),
                ...
                thisHeight = $self.height(), // Height of navigation wrapper
                ...
                menuItems = options.selector === "a" ? $self.find('li a').not(':last') : $self.find('li'), // Navigation lists or links
            ...
            menuItems.click(function(e) {
                ...
                if (clicks === 1 && ($self.offset().top > $selfScrollTop)) {
                    ...
                    $("html, body").stop().animate({
                        scrollTop: $(section).offset().top - parseInt($(section).css('marginTop')) -  thisHeight + 2 + 'px'
                    }, {
                        duration: options.animDuration,
                        easing: options.easing
                    });
                    ...
                    $("html, body").stop().animate({
                        scrollTop: $(section).offset().top - parseInt($(section).css('marginTop')) + 2 + 'px'
                    }, {
                        duration: options.animDuration,
                        easing: options.easing
                    });
            ...
            var mainFunc = function() {
                ...
                menuItems.parent().removeClass(options.activeClass);

                /* Add activeClass to the div that is passing the top of the window */
                section.each(function () {
                    var top = $(this).offset().top - parseInt($(this).css('marginTop')) - thisHeight,
                ...
                if (win.scrollTop() + windowHeight >= $(document).height()) {
                    ...
                    menuItems.parent().removeClass(options.activeClass).last().addClass(options.activeClass);
